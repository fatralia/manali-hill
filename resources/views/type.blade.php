        ...
        <div class="card">
          ...
          <div class="card-content">
            ...
            <p class="card-description">Tipe Emerald dengan void memiliki 2 luas <br>
              ...
              Memiliki fasilitas 2 kamar tidur dan 2 <br>
              kamar mandi. Mengutamakan <br>
              kenyamanan dengan mengoptimalkan <br>
              tata ruang yang efisien dan sirkulasi udara <br>
              yang sehat.</p>
              <p class="card-price"><span class="price-currency">IDR</span> 599.500.000/ Unit</p>
            <div class="card-images">
              <div class="card-image-item">
                <img src="../images/kasur.png" alt="Image 1" class="image1">
                <span>2</span>
        ...
        <div class="card">
          ...
          <div class="card-content">
            ...
            <p class="card-description">Villatel didesain setara dengan hunian <br>
              ...
              konsep villa modern 3 lantai. Didukung <br>
              dengan penataan ruang tamu yang efisien <br>
              membuat tipe ini menjadi hunian yang <br>
              nyaman dan hangat untuk keluarga <br>
              tercinta. Villatel dilengkapi dengan rooftop <br>
              dilantai tiga untuk kehangatan keluarga.</p>
              <p class="card-price"><span class="price-currency">IDR</span> 574.425.000/ Unit</p>
            <div class="card-images">
              <div class="card-image-item">
                <img src="../images/kasur.png" alt="Image 1" class="image1">
        ...
        <div class="card">
          ...
          <div class="card-content">
            ...
            <p class="card-description">Dibangun diatas tanah seluas 193m <br>
              ...
              Amethyst dilengkapi dengan taman dan <br>
              kolam renang pribadi. Hunian tipe <br>
              Amethyst sangat cocok digunakan sebagai <br>
              aset investasi di lokasi potensial terbaik di <br>
              Kota Malang serta digunakan sebagai <br>
              hunian tempat tinggal yang nyaman.</p>
              <p class="card-price"><span class="price-currency">IDR</span> 599.500.000/ Unit</p>
            <div class="card-images">
              <div class="card-image-item">
                <img src="../images/kasur.png" alt="Image 1" class="image1">
